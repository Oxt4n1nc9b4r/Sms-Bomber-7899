...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★]Oxt4n1nc9b4r\033[1;39m       ┃
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46mT4N1N-𝗖𝟵𝗕𝟰𝗥 SMS WAS SENT DONE😈")
  else:
    pass
  ...
  if send3.status_code==200:
    ses+=1
    print(f"\n{ses} \033[38;5;46T4N1N-𝗖𝟵𝗕𝟰𝗥 SMS WAS SENT DONE😈")
